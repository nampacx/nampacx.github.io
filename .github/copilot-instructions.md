...
Required frontmatter: `author` (always "Michael Kokonowskyj"), `pubDatetime` (ISO 8601 date), `title`, `description`, `tags` (string array), optional: `postSlug`, `featured`, `draft`, `ogImage`, `canonicalURL`.
